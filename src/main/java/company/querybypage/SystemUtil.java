...
public class SystemUtil {
    ...
    private static String SYSTEM_CONTEXT_PATH_KEY;
    ...
    public static String getContextPath() {
        return System.getProperty(SYSTEM_CONTEXT_PATH_KEY);
    }
     ...
     * @param filtNullProps 源bean的null属性是否覆盖目标的属性<li>true : 源bean中只有为null的属性才会被覆盖<li>false
